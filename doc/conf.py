...
latex_documents = [
    ("index.rst", "echo.tex", "echo Documentation", "Chris Beaumont and Thomas Robitaille", "manual"),
]
...
man_pages = [("index.rst", "echo", "echo Documentation", ["Chris Beaumont and Thomas Robitaille"], 1)]
...
texinfo_documents = [
    (
        ...
        "echo",
        "echo Documentation",
        "Chris Beaumont and Thomas Robitaille",
        "echo",
